...
const NguyenPhuLieu = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        message.error(res.message || "Không thể tải danh sách NPL");
      }
    } catch (err) {
      message.error("Lỗi khi tải danh sách NPL");
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchDvtHq = async () => {
    try {
      ...
      message.error("Lỗi khi tải danh sách đơn vị tính HQ");
    }
  };
  ...
  const handleEdit = async (record) => {
    try {
      ...
      message.error("Không thể tải chi tiết nguyên phụ liệu");
    }
  };
  ...
  const handleDelete = async (id_npl) => {
    try {
      ...
      message.error("Lỗi khi xóa nguyên phụ liệu");
    }
  };
  ...
  const onFinish = async (values) => {
    try {
      ...
      message.error("Lỗi khi lưu nguyên phụ liệu");
    }
  };
