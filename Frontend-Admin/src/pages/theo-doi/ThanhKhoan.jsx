...
// --- Dữ liệu giả lập (đã tinh gọn) ---
const initialData = [
  { id_bc: 1, id_hd: 1, so_hd: 'HD-2025-001', ten_dn: 'Công ty May Mặc ABC', thoi_gian_tao: '2025-09-15 10:30', ket_luan: 'HopLe', trang_thai: 'HopLe' },
  { id_bc: 2, id_hd: 2, so_hd: 'HD-2025-002', ten_dn: 'Xí nghiệp Dệt Phong Phú', thoi_gian_tao: '2025-09-18 14:00', ket_luan: 'DuNPL', trang_thai: 'HopLe' },
  { id_bc: 3, id_hd: 3, so_hd: 'HD-2025-003', ten_dn: 'Công ty Gỗ An Cường', thoi_gian_tao: '2025-09-20 11:00', ket_luan: 'ViPham', trang_thai: 'TamKhoa' },
  { id_bc: 4, id_hd: 4, so_hd: 'HD-2025-004', ten_dn: 'Công ty May Mặc ABC', thoi_gian_tao: '2025-09-21 09:30', ket_luan: 'HopLe', trang_thai: 'Huy' },
];
// -----------------------
...
const ThanhKhoanAdmin = () => {
  ...
  const showDrawer = (record) => { setSelectedReport(record); setIsDrawerOpen(true); };
  ...
  return (
    <>
      ...
      {/* SỬA ĐỔI: Drawer đã được tinh gọn */}
      <Drawer title={`Chi tiết Báo cáo #${selectedReport?.id_bc}`} width={600} onClose={closeDrawer} open={isDrawerOpen}>
        {selectedReport && (
